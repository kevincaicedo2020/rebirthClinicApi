...
export default function ButtonListSelect({ array, setValueInput, setIndexInput, backgroundColor, anchoInput, padding, Logo, nameLogo, sizeLogo, marginBottomInput, colorLogo, marginLeft, defaultButtonText, colorText, fontSize}) {
  return (
